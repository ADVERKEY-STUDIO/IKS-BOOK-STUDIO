...
try{
 const page=await browser.newPage({viewport:{width:1200,height:1000}});let count=0;const failures=[];await page.goto('http://127.0.0.1:5173/template-studio');await page.getByText('Loading…',{exact:true}).waitFor({state:'hidden'});
