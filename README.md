...
The children-first setup uses three age bands (7–9, 10–12 and 13–15), three distinct writing modes, and three complete visual worlds. Reader, writing and design choices each include a live book glimpse. Writing modes use separate summary pipelines: Friendly Guide explains evidence step by step, Story Journey turns it into a source-linked sequence of discoveries, and Curious Explorer organises it as questions, clues and tests. Age bands also change vocabulary and sentence length. Drafts remember the settings used to generate them, so an existing adaptation can be refreshed when its reader or writing mode changes. Adult-reader options are intentionally deferred to a later version.
