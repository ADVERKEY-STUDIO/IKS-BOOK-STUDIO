...
function renderPlannedArtwork(book:TemplateBook,b:Blueprint,url:string|undefined,scene:string,filename:string){
...
.planned-spread.iks-notes .note-heading{display:block;font-weight:400;margin-bottom:.3em}.note-heading::first-line{background:#fff37a}.planned-spread.iks-notes .meaning{outline:1px solid #b63332;outline-offset:2mm;color:#244a75}
