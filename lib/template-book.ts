...
export function templateFont(book:Pick<TemplateBook,'templateId'|'templateRevision'>){return book.templateRevision===2&&referenceContracts[book.templateId]?.sans?'book-sans.ttf':'book-sanskrit.ttf';}
