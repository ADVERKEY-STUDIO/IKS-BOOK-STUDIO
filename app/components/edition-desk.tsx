...
type Props = { onSnapshot:(final:boolean)=>Promise<Edition>; onBackup:()=>Promise<Blob>; onRestore:(file:File)=>Promise<void>; onArtUpload:(input:ArtUpload)=>Promise<void>; onArtPackage:(id:string)=>Promise<void>; onReferenceUpload: (input: ReferenceUpload) => Promise<void>; onReferenceImage: (key: string) => Promise<Blob>; onReferencePackage: (id: string) => Promise<void>; inspiration?: BookInspiration; onInspiration: () => void; onBrief: () => Promise<string>; edition: Edition; onAction: (action: EditionAction) => Promise<void>; onUpload: (file: File) => Promise<void>; onDownload: (key: string, name: string) => Promise<void>; onExport: () => Promise<string>; onBack: () => void; onReload: () => Promise<void> };
export function EditionDesk({ onSnapshot, onBackup, onRestore, onArtUpload, onArtPackage, onReferenceUpload, onReferenceImage, onReferencePackage, inspiration, onInspiration, onBrief, edition, onAction, onUpload, onDownload, onExport, onBack, onReload }: Props) {
