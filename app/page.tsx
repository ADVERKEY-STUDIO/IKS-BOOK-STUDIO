...
function CanvaPreview({ project: savedProject, exportBusy, pdfProgress, pdfExportMode, onClose, onDownload, onUseFormat, onSaveCanvaPage, onSetCanvaActive }: {
  project: Project;
  exportBusy: boolean;
  pdfProgress: number;
  ...
  useEffect(() => {
    ...
    const inspect = async () => {
      ...
      if (!cancelled) setQualityReport(assessBookFormatPreview(project.bookFormat, metrics, project.chapters.length));
    };
    void inspect();
