...
export default function TemplateStudio() {
    ...
    async function exportZip() { if (!book || !draft)
        ...
        throw Error('Font could not be packaged.'); entries['fonts/'+templateFont(book)] = new Uint8Array(await font.arrayBuffer()); const license = await fetch('/fonts/'+(templateFont(book)==='book-sans.ttf'?'OFL-NotoSansDevanagari.txt':'OFL-NotoSerifDevanagari.txt')); if (!license.ok)
