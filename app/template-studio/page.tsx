...
import { templates, templateAppearanceCss, parseTemplateBook, bookPrompt, continuationPrompt, renderTemplateBook, assetName, type TemplateBook, type TemplateId, type BookPage } from '../../lib/template-book';
